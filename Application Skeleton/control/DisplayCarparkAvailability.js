...
var location_coor = sessionStorage.getItem("near_place_lat") + "," + sessionStorage.getItem("near_place_lng");
document.getElementById("result_carpark").innerHTML = location_coor;
