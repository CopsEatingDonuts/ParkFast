...
svy21_to_wgs84 = (function(x_coords, y_coords) {
  conversion = 'curl "https://developers.onemap.sg/commonapi/convert/3414to4326?X='+x_coords+'&Y='+y_coords+'"';
  exec(conversion, function(error, stdout, stderr){
